...
export default function Nft({ nft }) {
  ...
  /**
   * decryptDescription method
   * @param {*} encryptedDescriptionString 
   * @param {*} encryptedSymmetricKeyString 
   */
    ...
    <div className='nft'>
        ...
        <div className='nft__details'>
            ...
            <div className='nft__description'>
              ...
              {showButton && (
                <button 
                  className='nft__decrypt' 
                  onClick={() => decryptDescription(nft.encryptedDescription, nft.encryptedSymmetricKey)}
                >
                  Decrypt
                </button>
              )}
